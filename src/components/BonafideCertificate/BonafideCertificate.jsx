...
const BonafideCertificate = ({formData, handleChange}) => {
    ...
    return (
        <div>
            <h1 className='text-base font-medium mt-4'>N.O.C Certificate</h1>
            ...
            <form action='' method='' className='mt-3'>
                <div className='flex flex-col md:flex-row'>
                    <div className='md:basis-1/2 lg:ml-16'>
                        <a href='/NOC.pdf' download className='border border-black border-solid h-8 w-36 text-sm block m-1 md:ml-3 rounded-md bg-[#0052CC] text-center p-1 text-white hover:bg-black hover:text-white'>
